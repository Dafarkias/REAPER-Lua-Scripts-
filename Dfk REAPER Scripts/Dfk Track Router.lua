--[[
 * ReaScript Name: Dfk Track Router
 * About: Project workflow utility for routing tracks in REAPER.
 * Author: Dfk
 * Licence: GPL v3
 * REAPER: 6.0
...
local startofit, endofit = string.find(filename, "Dfk Track Router.lua")
