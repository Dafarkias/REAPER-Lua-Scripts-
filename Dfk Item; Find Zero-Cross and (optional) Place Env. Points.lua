 --[[
NAME: Dfk Multiple Track Zero-Cross (Optional: Place Env. Points)

Suggested Instructions/Recommended Use:
    
    1. Select multiple items.
    
    1. Place a time-selection (not loop selection) over the portion of the selected items in which you want to 'find' the sample closest to being a multi-track zero-cross. 
	Time-selection must be 5 seconds or less in length. 
    
    2. Run script.
    
    3. Read message, and follow prompt. 
	
	NOTE: If you choose to place pre-volume envelope points, a 'V' shaped envelope will be created for each item at the sample closest to being a multi-track zero-cross. 
	This 'V' will be equal in length to your grid division (i.e., 1/32), and does not require 'snap' to be enabled in order to properly operate.
    
    4. Enjoy!

CATEGORY OF USE: Multi-Track Editing
AUTHOR: Dafarkias
LEGAL RAMIFICATIONS: GPL v.3
COCKOS REAPER THREAD: https://forum.cockos.com/showthread.php?t=221094
VERSION: 1.01
REAPER: 5.979
